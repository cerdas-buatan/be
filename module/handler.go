...
// signup
func SignUp2(db *mongo.Database, insertedDoc model.Pengguna, code string) error {
	...
	if !ValidateVerificationCode(insertedDoc.Akun.PhoneNumber, code) {
		return fmt.Errorf("kode verifikasi tidak valid")
	}
